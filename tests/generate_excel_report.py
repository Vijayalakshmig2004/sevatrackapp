...
def generate_excel_report():
    ...
    for i in range(1, 6):
        ...
        test_cases.append(["UI/UX", f"UI-RES-{i+5}", f"Verify layout responsiveness on tablet viewport (768px) for Page {i}", "Expected grid layout adjustment", "PASS", "Layout adjusts correctly"])
    for i in range(1, 6):
    ...
    # --- 4. Validation & Security Testing (25 cases) ---
    for i in range(1, 6):
